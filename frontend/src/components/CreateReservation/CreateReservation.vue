        ...
        <v-form class="max-page" ref="reservationForm">
          <v-row class="d-flex flex-row justify-space-around">
            <v-hover v-slot="{ isHovering, props }">
              <v-card
                class="ma-3 mb-2 mr-1 pa-2 d-flex justify-space-between flex-column"
                width="700"
                height="430"
                variant="outlined"
                  ...
                  <v-container>
                    <v-sheet height="290">
                      <v-row class="dflex flex-row justify-center align-center">
                        <v-col
                          v-for="(pet, index) in historyList"
                          :key="index"
                          height="120"
                          width="305"
                        >
                          ...
                          >
                            <v-card
                              :class="['pa-5 d-flex flex-row', selectedClass]"
                              dark
                              height="130"
                              width="305"
                              @click="toggle"
                            ...
                            >
                              <v-card-item class="pa-0">
                                <img
                                  width="80"
                                  :src="
                                    require('@/assets/placeholder/placeholder_dog.png')
                                  "
                                />
                              </v-card-item>
                              <v-card-item>
            ...
            <v-hover v-slot="{ isHovering, props }">
              <v-card
                class="ma-3 mb-2 pa-2 d-flex justify-space-between flex-column"
                width="305"
                height="430"
                variant="outlined"
                :elevation="isHovering ? 8 : 0"
          ...
          <v-row class="d-flex flex-row justify-space-around">
            ...
            <v-hover v-slot="{ isHovering, props }">
              ...
              >
                ...
                <v-card-item>
                  <p>
                    상담 예약을 위해, 기입한 반려동물의 정보가 모든 전문가
...
export default {
  ...
  methods: {
    ...
    createReservation() {
      ...
      api
        .post(process.env.VUE_APP_API_BASE_URL + `/reservation`, frm, {
    ...
    async petInfo() {
      ...
      await api
        .get(
          `${process.env.VUE_APP_API_BASE_URL}/reservation/pet-list/${this.userId}`
        )
        .then(({ data }) => {
