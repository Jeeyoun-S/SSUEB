      ...
      await api
        ...
        .then(() => {
          ...
          this.$swal
            .fire({
              title: "상담 제안 수락",
              html: `상담 제안을 수락하고, 결제를 진행하시겠습니까? <br> <strong>상담날짜</strong> ${this.reservationItem.reservationDate} <br> <strong>전문가</strong> ${consultantName} (반려동물행동지도사) <br> <strong>결제금액</strong> ${matchingCost}`,
              icon: "warning",
                ...
                this.$swal
                  ...
                  .then(() => {
                    if (result.isConfirmed) {
                      this.$swal.fire({
                        title: "상담 제안 확정",
                        html: `<strong>상담날짜</strong> ${this.reservationItem.reservationDate} <br> <strong>전문가</strong> ${consultantName} (반려동물행동지도사) <br> <strong>반려동물</strong> ${this.reservationItem.petName} (${this.reservationItem.petType})`,
                        icon: "success",
