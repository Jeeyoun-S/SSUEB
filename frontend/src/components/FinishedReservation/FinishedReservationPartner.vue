    ...
    <v-expansion-panels v-model="panel" multiple>
      <v-expansion-panel v-for="(reservation, idx) in reservations" :key="{idx}">
        ...
        <v-expansion-panel-text class="pa-3">
          <v-sheet class="mb-5 d-flex flex-row justify-space-between align-start" height="210" width="998">  
            <v-hover
            ...
            >
              <v-card
                ...
                height="210" width="600" rounded="0"
                v-bind="props"
              >
                <!-- 좌측 반려동물 정보 -->
                <v-card class="mr-5 d-flex flex-column justify-center align-center" height="180" width="200" elevation="0">
                ...
                <!-- 우측 상담 신청 내용 -->
                <v-card class="d-flex flex-column" height="180" width="420" elevation="0">
